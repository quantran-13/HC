...
def dilate_attention_unet(input_size=(216, 320, 1), n_filters=64, batchnorm=True, dropout_rate=0.1, freeze=False, freeze_at=0):
    ...
    # u5 = ZeroPadding2D(((1, 0), (0, 0)), data_format="channels_last")(u5)
    ...
    c6 = conv2d_block(u7, n_filters * 1, kernel_size=3, batchnorm=batchnorm)
    ...
    if freeze:
        ...
        model_tmp = load_model_from_path("../models/model_dilate_attention_unet.hdf5")
